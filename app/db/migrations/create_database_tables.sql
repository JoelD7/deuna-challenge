...
INSERT INTO `cards` ( `card_number`, `customer_id`, `expiration`, `vendor`,`type`, `ccv`, `created_date`, `updated_date` ) VALUES (1654720058763025, '1', '12/2028', 'Visa', 'debit', 123, datetime(), datetime());
INSERT INTO `cards` ( `card_number`, `customer_id`, `expiration`, `vendor`,`type`, `ccv`, `created_date`, `updated_date` ) VALUES (7048506547895036, '2', '05/2028', 'Mastercard', 'credit', 788, datetime(), datetime());
...
INSERT INTO `payments` ( `id`, `merchant_account_id`, `customer_id`, `card_number`, `transaction_id`, `amount`, `status`, `failure_reason`, `created_date`, `updated_date` ) VALUES ('1', '4', '1', 1654720058763025, '1', 100.00, 'success', '', datetime(), datetime());
INSERT INTO `payments` ( `id`, `merchant_account_id`, `customer_id`, `card_number`, `transaction_id`, `amount`, `status`, `failure_reason`, `created_date`, `updated_date` ) VALUES ('2', '5', '2', 7048506547895036, '2', 200.00, 'success', '', datetime(), datetime());
INSERT INTO `payments` ( `id`, `merchant_account_id`, `customer_id`, `card_number`, `transaction_id`, `amount`, `status`, `failure_reason`, `created_date`, `updated_date` ) VALUES ('3', '6', '3', 5004896175620369, '3', 300.00, 'success', '', datetime(), datetime());